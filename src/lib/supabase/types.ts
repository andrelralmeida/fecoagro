  ...
  public: {
    Tables: {
      ...
      razao: {
        ...
        Relationships: [
          {
            foreignKeyName: "razao_atividade_id_fkey"
            columns: ["atividade_id"]
            isOneToOne: false
            referencedRelation: "atividades"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "razao_centro_custo_id_fkey"
            columns: ["centro_custo_id"]
            isOneToOne: false
            referencedRelation: "centro_custos"
            referencedColumns: ["id"]
      ...
      reconciliation_patterns: {
        Row: {
          ...
          id: string
          target_centro_custo_id: number | null
          target_plano_conta_id: number | null
          updated_at: string
          user_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "reconciliation_patterns_target_centro_custo_id_fkey"
            columns: ["target_centro_custo_id"]
            isOneToOne: false
            referencedRelation: "centro_custos"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "reconciliation_patterns_target_plano_conta_id_fkey"
            columns: ["target_plano_conta_id"]
            isOneToOne: false
            referencedRelation: "plano_contas"
            referencedColumns: ["id"]
          },
