    ...
    switch (entityType) {
      ...
      case 'razao': {
        ...
        records = parsedRazao.map((r: any) => ({
          ...
          atividade_id: r.atividade_id && vAti.has(r.atividade_id) ? r.atividade_id : null,
          centro_custo_id: r.centro_custo_id && vCC.has(r.centro_custo_id) ? r.centro_custo_id : null,
          plano_conta_id: r.plano_conta_id && vPC.has(r.plano_conta_id) ? r.plano_conta_id : null,
        }))
        break
      }
      case 'bancos':
